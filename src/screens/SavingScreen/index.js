    ...
    render() {
        ...
        return (
            <View style={styles.wrapper}>
                ...
                {
                    savings.Loading ? <PText>Loading</PText> :
                        <FlatList
                ...
                <ModalBox
                    ...
                    transparent
                    title="Edit Saving"
                    primaryAction={<PrimaryButton text="Update" onPress={this.onUpdateSaving} disabled={!this.state.savingFromUpdate || !this.state.savingAmountUpdate} />}
                    secondaryAction={<SecondaryButton text="Delete" style={{ text: { color: 'red' } }} onPress={this.onRemoveSaving} />}
                >
                    <TextField
