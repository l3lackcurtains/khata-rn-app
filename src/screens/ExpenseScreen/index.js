...
class ExpenseScreen extends Component {
    ...
    onUpdateExpense = () => {
        ...
        const query = { expenseAmount: expenseAmountUpdate, expenseFrom: expenseFromUpdate, index };
    ...
    render() {
        ...
        return (
            <View style={styles.wrapper}>
                ...
                {
                    expenses.Loading ? <PText>Loading</PText> :
                        <FlatList
                ...
                <ModalBox
                    ...
                    transparent
                    title="Edit Expense"
                    primaryAction={<PrimaryButton text="Update" onPress={this.onUpdateExpense} disabled={!this.state.expenseFromUpdate || !this.state.expenseAmountUpdate} />}
                    secondaryAction={<SecondaryButton text="Delete" style={{ text: { color: 'red' } }} onPress={this.onRemoveExpense} />}
                >
                    <TextField
